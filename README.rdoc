...
The email headers can be disabled by using the +show_headers+ option.

  config.action_mailer.letter_opener_settings.show_headers = false
...
config.letter_opener_settings = ActiveSupport::OrderedOptions.new
config.letter_opener_settings.show_headers = false
